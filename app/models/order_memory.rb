class OrderMemory
  ...
  def save
    ...
    Order.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, addresses: addresses, addresses: addresses, building: building, phone_number: phone_number, memory_id: memory.id)
  end
end